            ...
            <article className="space-y-12">
              {blog.sections.map((section) => (
                <div key={section.heading} className="space-y-6">
                  ...
                  {section.insight ? (
                    <div className="rounded-[24px] border border-[#0E0E0E]/10 bg-[#FFD700]/15 p-6">
              ...
              <figure className="rounded-[32px] border border-[#0E0E0E]/10 bg-[#0E0E0E]/5 p-8">
                <Icon icon="mdi:format-quote-close" className="text-4xl text-[#FFD700]" />
                ...
                <ul className="mt-6 space-y-4 text-base leading-relaxed text-[#0E0E0E]/80">
                  {blog.keyPoints.map((point) => (
                    <li key={point} className="flex gap-3">
                      <span className="mt-1 h-2 w-2 flex-shrink-0 rounded-full bg-[#f21b29]" />
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
