...
export function Footer() {
  return (
    <footer className="bg-[#0E0E0E] text-[#D2FDFF]">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-16 lg:px-10 xl:px-14">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.4fr),minmax(0,2fr)] lg:items-start">
          <div className="space-y-6">
            <Logo />
            <p className="max-w-sm text-sm leading-relaxed text-[#D2FDFF]/75">
              Bringing architectural visions to life with bold design, precise
              engineering, and a commitment to timeless quality.
            </p>
            <p className="text-xs uppercase tracking-[0.35em] text-[#D2FDFF]/50">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            {footerColumns.map((column) => (
              <div key={column.heading} className="space-y-4">
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#D2FDFF]/70">
                  {column.heading}
                </p>
                <ul className="space-y-3 text-sm text-[#D2FDFF]/80">
        ...
        <div className="flex flex-col items-start gap-4 border-t border-white/10 pt-6 text-xs text-[#D2FDFF]/60 sm:flex-row sm:items-center sm:justify-between">
