...
export const metadata: Metadata = {
  title: {
    default: "Yashraj Infrastructure - A Yashraj Group Company | Building Beyond Horizons",
    template: "%s | Yashraj Infrastructure",
  },
  description:
    "Yashraj Infrastructure is a trusted government partner based in Navi Mumbai, delivering infrastructure projects across Maharashtra since 2005. We offer construction, operation & maintenance, buildings & industrial projects, plus bitumen mixes and ready-mix concrete.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Trusted government partner in Navi Mumbai. Infrastructure projects across Maharashtra. Construction, O&M, bitumen mixes, and ready-mix concrete.",
    images: [{ url: "/images/hero.jpg", width: 1200, height: 630, alt: "Yashraj Infrastructure" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Yashraj Infrastructure | Building Beyond Horizons",
    description: "Trusted government partner in Navi Mumbai. Infrastructure across Maharashtra.",
